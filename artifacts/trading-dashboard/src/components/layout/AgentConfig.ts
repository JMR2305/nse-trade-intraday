...
export const AGENTS: Agent[] = [
  // ── Agent 1 — Market Data ──────────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      { href: "/custom-universe-management", label: "Universe Management", icon: Database, tags: ["universe", "membership", "revision", "mapping", "draft"] },
  ...
  // ── Agent 10 — Operations ─────────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      { href: "/operational-intelligence", label: "Operational Intelligence", icon: Activity,   tags: ["operational", "intelligence", "timeline", "checklist", "pre-market", "comparison", "insights", "health score", "executive", "phase27.1"] },
      ...
      { href: "/institutional-analytics", label: "Institutional Analytics", icon: BarChart3,     tags: ["institutional", "analytics", "lab", "leaderboard", "calibration", "monte carlo", "equity curve", "drawdown", "phase23"] },
