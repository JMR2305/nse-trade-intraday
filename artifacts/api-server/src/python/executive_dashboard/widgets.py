...
def widget_paper_analytics(data: dict) -> dict:
    ...
    return {
        "available":       True,
        "disabled":        False,
        "analytics_score": _sf(pa, "analytics_score", 0.0),
        "grade":           _as_str(_g(pa, "grade",    default="N/A")),
        "win_rate":        _sf(pa, "win_rate",        0.0),
        "profit_factor":   _sf(pa, "profit_factor",   0.0),
        "total_trades":    int(_sf(pa, "total_trades", 0.0)),
        "total_pnl":       _sf(pa, "total_pnl",       0.0),
        "sharpe_ratio":    _sf(pa, "sharpe_ratio",    0.0),
