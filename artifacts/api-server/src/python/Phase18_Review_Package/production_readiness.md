...
- System health: OK · memory 69.3 MB ·
  context build latency 4.9 ms (see diagnostics.json).
...
## Readiness checklist
- **unified_scan_context** — PASS: Canonical scan 9da319f3de18 — single scan_id/snapshot_ts: True
- **cross_page_consistency** — WARN: 72 checks, 49 mismatches
- **no_stale_data** — PASS: Scan age 8m
...
- **audit_logging** — PASS: Audit record for scan 9da319f3de18
