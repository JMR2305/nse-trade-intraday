...
Generated 2026-07-15 17:30 UTC — PAPER TRADING / RESEARCH ONLY.
...
- System health: OK · memory 94.9 MB ·
  context build latency 1.0 ms (see diagnostics.json).
...
## Readiness checklist
- **unified_scan_context** — PASS: Canonical scan 09070889504f — single scan_id/snapshot_ts: True
...
- **audit_logging** — PASS: Audit record for scan 09070889504f
