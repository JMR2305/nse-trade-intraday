...
Generated 2026-07-15 16:13 UTC — PAPER TRADING / RESEARCH ONLY.

## Runtime health
- API server and dashboard were running at generation time (this package was produced through them).
- System health: OK · memory 94.5 MB ·
  context build latency 1.7 ms (see diagnostics.json).
...
## Readiness checklist
- **unified_scan_context** — PASS: Canonical scan d467fffac5c0 — single scan_id/snapshot_ts: True
- **cross_page_consistency** — WARN: 72 checks, 49 mismatches
- **no_stale_data** — PASS: Scan age 5m
...
- **audit_logging** — PASS: Audit record for scan d467fffac5c0
